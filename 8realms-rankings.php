...
add_action( 'init', function() {
    // Register blocks using metadata
    register_block_type_from_metadata( __DIR__ . '/build/blocks/rankings-table' );
    register_block_type_from_metadata( __DIR__ . '/build/blocks/searchable-rankings-table' );
    register_block_type_from_metadata( __DIR__ . '/build/blocks/player-profile' );
    register_block_type_from_metadata( __DIR__ . '/build/blocks/faction-rankings' );
} );
...
// 			'name' => $manifest_data[$block_type]['name'], // Ensure namespace-prefixed name
// 		] );
// 	}
// }
